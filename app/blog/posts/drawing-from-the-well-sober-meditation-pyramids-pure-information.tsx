...
export const metadata: PostMeta = {
  ...
  canonicalUrl: "https://cyberworldbuilders.com/blog/drawing-from-the-well-sober-meditation-pyramids-pure-information",
  topics: ["Personal Development", "Philosophy & Spirituality"],
  tags: ["meditation", "consciousness", "spirituality", "lucid-dreaming", "ancient-history", "philosophy", "psychedelics", "information-theory"],
  category: "Philosophy",
  isFeatured: false,
  priority: 5,
};
...
export default function Post() {
  return (
    <PostLayout meta={metadata}>
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Practice</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Puzzle</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">Where the Gods Hatched</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">Pure Information</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">Leary, Kesey, and the Dopamine Trap</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">What If They Already Figured It Out?</h2>
