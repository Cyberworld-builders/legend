...
export const metadata: PostMeta = {
  ...
  description: "After building out the blog pipeline and SEO automations, here's the roadmap for CyberWorld — from generative search optimization to a unified dashboard to a three-tier service model that makes traditional SaaS obsolete.",
  slug: "where-im-going-next",
  headerImage: "/images/where-im-going-next-hero.png",
  socialImage: "/images/where-im-going-next-hero.png",
  publishedDate: "2026-03-08",
  modifiedDate: "2026-03-08",
  keywords: ["cyberworld builders", "seo automation", "generative engine optimization", "geo", "saas", "digital marketing", "ai automation", "blog publishing pipeline", "claude code", "open claw"],
  canonicalUrl: "https://cyberworldbuilders.com/blog/where-im-going-next",
  topics: ["Business & Marketing", "AI & Automation", "Career & Professional Development"],
  tags: ["cyberworld", "seo", "geo", "automation", "saas", "digital-marketing", "claude-code", "roadmap"],
...
export default function Post() {
  return (
    <PostLayout meta={metadata}>
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Epoch Moment</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Pipeline That Changed Everything</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">What&apos;s Next: SEO End-to-End and GEO</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Unified Dashboard</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">CyberWorld&apos;s Three-Tier Model</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">SaaS Is Dying. This Is What Replaces It.</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 mt-8 text-[#00ff00]">The Pace Right Now Is Unreal</h2>
