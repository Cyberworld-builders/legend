      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-[#00ff00]/70 max-w-2xl mx-auto">
            I&apos;m a software engineer who builds marketing systems and automation
            for service businesses. I work with teams to identify bottlenecks
            and build solutions that actually get used.
          </p>
        </div>
